...
const CtaSection: React.FC = () => {
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-blueDark to-[#0f2435]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:space-x-4">
            <Link
              to="/projetos"
              className="bg-white text-blueDark hover:bg-gray-100 py-3 px-6 sm:px-8 rounded-lg text-lg font-semibold inline-block transition-all duration-300 hover:scale-105 shadow-lg text-center"
            >
              Ver projetos
            </Link>
            <Link
